...
#import "CTWBaseRequestProtocol.h"
#import "CTURLModel.h"
 ...
 *  @return 返回的对象可取消请求,调用cancel方法
 */
+ (__kindof NSURLSessionTask *)POST:(CTURLModel *)urlM
                      responseCache:(PPHttpRequestCache)responseCache
                            success:(PPHttpRequestSuccess)success
                            failure:(PPHttpRequestFailed)failure;
 ...
 *  @return 返回的对象可取消请求,调用cancel方法
 */
+ (__kindof NSURLSessionTask *)uploadFileWithURL:(CTURLModel *)urlM
                                            name:(NSString *)name
 ...
 *  @return 返回的对象可取消请求,调用cancel方法
 */
+ (__kindof NSURLSessionTask *)uploadImagesWithURL:(CTURLModel *)urlM
                                              name:(NSString *)name
 ...
 */
+ (__kindof NSURLSessionTask *)downloadWithURL:(CTURLModel *)urlM
